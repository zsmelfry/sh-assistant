...
// 8 learning stages with knowledge point mappings (by name)
export const SEED_STAGES: SeedStage[] = [
  {
    name: '全貌认知',
    description: '了解创业运营涉及的所有领域，建立全局框架',
    objective: '理解创业运营的完整流程，每个领域是什么、为什么重要',
    pointNames: [
      '市场规模评估', '品牌定位方法论', '产品需求定义', '寻找工厂',
      '贸易术语', '法国公司类型', '独立站搭建', '社交媒体营销',
      '启动资金估算', '售后服务体系',
    ],
  },
  {
    name: '市场验证',
    description: '深入研究市场机会、竞争格局和目标客户',
    objective: '确认市场机会存在，了解竞争格局和目标客户',
    pointNames: [
      '行业趋势分析', '市场细分', '竞品识别与分类', '竞品产品对比',
      '竞品营销策略分析', '目标客户画像', '消费者需求洞察', '购买决策流程',
      '消费者调研方法', '商业计划书', '融资方式',
    ],
  },
  {
    name: '合规准备',
    description: '掌握公司注册、产品合规、进出口和税务规则',
    objective: '掌握法律、进出口、税务等必须遵守的规则',
    pointNames: [
      '注册流程', '银行账户与财务设置', 'EU 纺织品法规', '产品安全标准',
      '标签要求', '功能性产品声明', '商标注册', '外观设计保护',
      '退换货政策', '隐私与数据保护', '电商法律要求',
      '出口流程', '进口流程', '关税与 HS 编码', '增值税 (TVA)',
      '双边贸易政策', '合规检测',
    ],
  },
  {
    name: '产品与供应链',
    description: '完成产品设计、供应商选择和生产管理',
    objective: '从产品设计到找工厂到质检的完整链路',
    pointNames: [
      '材料与工艺选择', '尺码体系', '产品打样', '功能测试', '用户测试',
      '验厂与评估', '供应商谈判', '供应商关系维护',
      '生产排期', '质量控制', '成本控制', '库存策略', '仓储方案',
    ],
  },
  {
    name: '品牌建设',
    description: '创建品牌识别体系和品牌管理方案',
    objective: '建立品牌定位、视觉识别和品牌故事',
    pointNames: [
      '品牌命名', '品牌故事', '视觉识别系统', '包装设计',
      '品牌调性与语言', '品牌资产管理', '品牌保护策略',
    ],
  },
  {
    name: '渠道搭建',
    description: '建立线上线下销售渠道和物流配送体系',
    objective: '建立线上/线下销售渠道，准备上线',
    pointNames: [
      '电商平台入驻', '平台运营', '药房/医疗用品店', '批发与分销',
      '展会与行业活动', '渠道选择与优先级',
      '国际运输方式', '物流服务商', '最后一公里',
    ],
  },
  {
    name: '营销推广',
    description: '制定营销策略，获取第一批客户',
    objective: '获取第一批客户，建立营销体系',
    pointNames: [
      '搜索引擎优化 (SEO)', '付费广告', '邮件营销', '内容策略',
      '健康教育内容', 'KOL/KOC 合作', '品牌上市策划', '公关与媒体',
      '成本结构分析', '定价策略', '定价与渠道协调',
    ],
  },
  {
    name: '运营优化',
    description: '完善客户服务、财务管理和数据驱动优化',
    objective: '客户服务、财务管理、持续改进',
    pointNames: [
      '退换货处理', '客户投诉处理', '客户获取成本 (CAC)',
      '客户生命周期价值 (LTV)', '忠诚度计划',
      '关键指标体系', '数据分析工具', 'A/B 测试',
      '记账与发票', '现金流管理', '税务申报', '利润率管理',
      '产品线规划', '基于反馈的改进', '品牌口碑', '社区建设', '全渠道体验',
    ],
  },
];
